...
El conjunto de métodos de un objeto pone a disposición de otros objetos (que son aquellos que comienzan con la palabra reservada `public`) se denomina _interfaz de la clase_.
