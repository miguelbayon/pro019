...
<img align="right" style="width: 70%"; margin: 0 0 20px 20px" src="0568.png">
...
El proyecto que utilizaremos para hablar de la interacción entre objetos es una pantalla para un reloj digital. La pantalla muestra las horas y los minutos separados por un carácter de dos puntos en formato de visualización de 24 horas al estilo europeo. Por tanto, la pantalla mostrará la hora desde las 00:00 (medianoche) hasta las 23:59 (un minuto antes de medianoche). 
